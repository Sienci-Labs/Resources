...
2. How to prepare wood for a finish
3. How to apply varnish
4. How to apply poly
5. Can you mix oil stains and polyurethane 
5. What are gel stains and poly
5. What are water based finishes
5. What is water based stain
...
4. [Staining](#staining)
5. [Sealing](#sealing)
6. [Finish Comparison Chart](#finish-comparison-chart)
...
|-------------------|-------------------|------------------------------------------|
| Rough Sanding     | 80-100 grit       | Removes large burrs, rough edges.        |
...
Lightly sand the raised grain: Once the wood is completely dry, lightly sand the surface with fine-grit sandpaper (320 or higher). The goal is to knock down the raised fibers without removing too much material or damaging the wood.
Sand gently: Use light pressure and sand with the grain to avoid scratches.
Check the surface: Feel the wood to ensure it’s smooth again.
Repeat if Necessary

For water-based finishes: If you plan to use a water-based finish, consider raising the grain and sanding it down again to be certain that the wood fibers won't rise when you apply the finish.
Proceed with Staining or Finishing
...
Water-Based Finishes: These tend to raise the grain more than oil-based finishes, so it’s especially important to raise the grain beforehand if you’re using water-based products.
Oil-Based Finishes: Oil-based stains and finishes don't raise the grain as much, but it’s still a good practice to prepare the wood properly.
...
Painting adds color and personality to your CNC project. Here’s a general guide:
...
1. **Prime the Surface** (Optional but Recommended):  
   Use a primer to help the paint adhere better and cover the natural wood grain.

2. **Apply Paint in Thin Layers**:  
   Use a brush or spray in even, thin coats. Allow drying between coats (typically 1-2 hours, depending on the paint).

3. **Light Sanding Between Coats (320-400 Grit)**:  
   This helps smooth any imperfections or raised grain caused by moisture in the paint.
...
2. **Apply Stain with a Brush or Cloth**:  
...
Sealing your CNC project protects it from moisture, scratches, and wear. Choose the right sealer for your project:
...
3. **Sand Lightly Between Coats (320+ Grit)**:  
...
## 6. Finish Comparison Chart

This chart helps you compare different finishing options for your CNC project:
...
1. Preparation
Clean the Surface: Remove any dust and debris from the CNC process using a soft brush or vacuum.
...
7. Non-Grain Raising (NGR) Stains
...
9. Metalized or Polyurethane-Based Stains
...
5. Consider Using a Paint Stencil Adhesive
