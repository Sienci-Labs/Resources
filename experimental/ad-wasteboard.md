...
Improves on https://resources.sienci.com/view/lmk2-wasteboard/

- Better explain what surfacing accomplishes (diagram?), bit selection for the task, and the different ways to set it up
