...
Tramming keeps your router perpendicular to the wasteboard so surfacing passes stay clean. Here’s a simplified process any hobby CNC user can follow.
...
![wasteboard ridges acceptable vs severe](image_placeholder)
...
![wasteboard surfacing smooth vs ridged](image_placeholder)
...
5. **Resurface wasteboard** regularly for best results.
...
Tramming is the process of aligning the CNC machine’s spindle perpendicular to the machine's work surface (wasteboard or table). Proper tramming ensures that tools cut evenly across the entire work area, improving surface finish and accuracy.
...
An accuracy of 0.1mm is a good goal to try and achieve. About the thickness of a piece of regular paper. You will be hard pressed to see 0.01 mm of accuracy, and even this level can still show ridges in your wasteboard.

## General Step-by-Step Tramming Process

### Check for wasteboard Flatness

Use a straight edge to ensure the wasteboard is flat. Resurfacing the wasteboard if necessary to create a level reference plane.
...
Mount the arm in the spindle collet. You can also use a tramming gauge. Rotate the spindle by hand to check the height of the wasteboard at multiple points.
...
- Use shims or adjustment screws to tilt the spindle forward or backward until it aligns perpendicular to the wasteboard in the X-axis.
...
- Resurface the wasteboard regularly to maintain a consistent reference plane.
...
- [Setting Up Your wasteboard (20 min)](https://youtu.be/q6S73Iu-z5o)
...
For a detailed walkthrough of tramming your machine using a mirror for the surface, check out [this article](https://www.servomagazine.com/magazine/article/how-to-tram-your-cnc-router)
