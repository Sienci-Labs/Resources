...
![alt text](../../_images/_mill-one/_the-basics/mo_tools_p1_EndMills.jpg){.aligncenter .size-medium}
...
![alt text](../../_images/_mill-one/_the-basics/mo_tools_p2_EMillMarked.png){.aligncenter .size-medium}
...
![alt text](../../_images/_mill-one/_the-basics/mo_tools_p3_BallvsEnd.jpg "Ballnose mill vs End mill vs V-bit"){.aligncenter .size-medium}

![alt text](../../_images/_mill-one/_the-basics/mo_tools_p4_Fishtail.jpg "1/4″, 1/8″, and 1mm end mills"){.aligncenter .size-medium}

![alt text](../../_images/_mill-one/_the-basics/mo_tools_p5_BallNose.jpg "3/8″ and 1/8″ ballnose mills"){.aligncenter .size-medium}

![alt text](../../_images/_mill-one/_the-basics/mo_tools_p6_VBit.jpg "90°, 35°, and 20° v-bits"){.aligncenter .size-medium}
...
The flutes on the cutting tools are the cutting edges that remove material but also act as channels which move chips and dust away from the cut. Most tools have two or four flutes, but you can find tools with any number of flutes. When an cutting tool has less flutes, more material can be cut away per flute, per rotation. This means that fewer flutes will remove material faster, at the downside of making rougher cuts, meanwhile having more flutes increases the chance of a smoother surface finish.
 ...
 ![alt text](../../_images/_mill-one/_the-basics/mo_tools_p7_Flutes.jpg "2-flute vs. 4-flute end mills"){.aligncenter .size-medium}
...
![alt text](../../_images/_mill-one/_the-basics/mo_tools_p8_SCarbidevsHSS.jpg "Solid carbide vs. HSS cutting tool"){.aligncenter .size-medium}
