...
![](/_images/_gsender/_using/gs_us_connect.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_connected-idle.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_jogging.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_jog-presets.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/_zerogoto/gs_fe_ze_zero-individual.jpg){.aligncenter .size-medium}
1. Set the zeros all at once using 'Zero All'
![](/_images/_gsender/_features/_zerogoto/gs_fe_ze_zero-all.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/_zerogoto/gs_fe_ze_quick-travel.PNG){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/_probing/gs_fe_pr_begin.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/_probing/gs_fe_pr_confirm.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/_probing/gs_fe_pr_success.PNG){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_load-g-code.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_file-stats.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_visualize.gif){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_outline-test-run.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_running.gif){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_override.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_job-loss-1.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_job-loss-2.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_job-loss-notice.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_using/gs_us_safety.png){.aligncenter .size-medium}
