...
![](/_images/_gsender/_features/gs_features_p28_Squaring2.png){.aligncenter .size-medium}
1. Measure the distance between the marked points and record the values
![](/_images/_gsender/_features/gs_features_p29_Squaring3.png){.aligncenter .size-medium}
1. Adjust your rail positions with the values determined by the XY Squaring procedure
![](/_images/_gsender/_features/gs_features_p30_CalResults.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p31_Tuning1.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p32_Tuning2.png){.aligncenter .size-medium}
1. Change the EEPROM setting as recommended by the procedure by pressing 'Set EEPROM setting'
![](/_images/_gsender/_features/gs_features_p33_Tuning3.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p35_SurfaceStats.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p36_SurfaceDirection.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p37_Generategcode.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p38_RunMainVis.png){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p54_RemoteMode.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p56_RestartApp.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p57_ErrorPopup.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p58_Success.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p60_Remote.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p61_IPAddress.jpg){.aligncenter .size-medium}
...
1. Double check you took the right steps in the Firewall Setup section. Your inline computer might be blocking gSender’s ability to send information to the internet because of the firewall. On Windows, follow these steps to modify the firewall:
   ...
   ![](/_images/_gsender/_features/gs_features_p63_ControlPanel.jpg){.aligncenter .size-medium}
   - Open the ‘System and Security’ settings
   ![](/_images/_gsender/_features/gs_features_p64_SysSecurity.jpg){.aligncenter .size-medium}
   - Open the ‘Windows Defender Firewall’ and go to its ‘Advanced settings’
   ![](/_images/_gsender/_features/gs_features_p65_Firewall.jpg){.aligncenter .size-medium}
   ...
   ![](/_images/_gsender/_features/gs_features_p66_InboundRules.jpg){.aligncenter .size-medium}
   ...
   ![](/_images/_gsender/_features/gs_features_p67_ProtocolsPorts.jpg){.aligncenter .size-medium}
...
![](/_images/_gsender/_features/gs_features_p68_ConnLost.jpg){.aligncenter .size-medium}
