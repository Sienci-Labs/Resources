...
If you want to change the bits we are using, tweak the speeds/feeds, use a different material size/thickness or change the wording on the cookies, you can! Simply open up this file with VCarve Pro and you can change any of the details on the file. <a href="https://drive.google.com/file/d/1n0x6ShIdfboqd-JfHM3rXVxhxH1UhCqw/view?usp=drive_link" target="_blank" rel="noopener">Vectric VCarve Pro file</a>

### Toolpaths File

If you have material that is 451 mm (17.75 in) width, 380mm (15 in) height and 6.35mm (0.25 in) thick, you can simply load up this file in gSender. Set your zero starting point, and begin the carve! Here are the <a href="https://drive.google.com/file/d/1Y9XxEj8HlJhAuF-6ksZT7vEfzeuGDQRK/view?usp=drive_link" target="_blank" rel="noopener">g-Code toolpaths</a> all saved to one file.
...
**Tool 2**  
1/16" downcut end mill for pocketing large blocky text (1/8 shaft)
...
![](/_images/_atc/_atc_basics/atc_basics_firstpro-design2.jpg){.aligncenter .size-medium}
...
![](/_images/_atc/_atc_basics/atc_basics_firstpro-toolpathsv3.jpg){.aligncenter .size-medium}

1. We’ll select the single line text and create a profile toolpath using Tool 1. We’ll set a conservative depth. Light engraving is ideal for this first run. Ensure you have the Machine Vectors set to ON.

1. Select the large text and the 1/16th bit with a pocket toolpath.

1. Use the 1/8 tapered ball nose bit for the smaller text with a pocket toolpath.
...
I've named each toolpath with the corresponding tool number, in the order I'd like them to carve. Let's preview all of the toolpaths!

![](/_images/_atc/_atc_basics/atc_basics_firstpro-preview.jpg){.aligncenter .size-medium}
...
![](/_images/_atc/_atc_basics/atc_basics_firstpro-toolone.jpg){.aligncenter .size-medium}
...
![](/_images/_atc/_atc_basics/atc_basics_firstproject_postprov3.jpg){.aligncenter .size-medium}
...
1. Press Start!
    ...
    Friendly reminder to turn on your dust collection at this point! When we start the program, the machine will begin with the V-bit. Once complete, the spindle will stop, return to the rack, perform the tool change, and pick up the 1/16 downcut end mill, tap on the tls then, continue the cut.
...
You may find that you have made a mistake with your tool numbers/placement in the tool rack. If you want to swap out a tool, without manually changing the placement, you can remap on the software side!

1. On the tool timeline, press the remapping button for the tool you want to remap. In the image below we are remapping tool 3.

    ![](/_images/_atc/_atc_basics/atc_basics_firstproject_remap1.jpg){.aligncenter .size-medium}

1. This will bring up a popup that allows you to select a new tool in the dropdown menu.

    ![](/_images/_atc/_atc_basics/atc_basics_firstproject_remap2.jpg){.aligncenter .size-medium}

1. Select the tool you want, and you will see it ready to confirm your selection.

    ![](/_images/_atc/_atc_basics/atc_basics_firstproject_remap3.jpg){.aligncenter .size-medium}

1. Once successfully remapped, you can see the edit in the tool timeline is reflected and now tool 3 is using tool 4, without swapping out the tool holders physically.

    ![](/_images/_atc/_atc_basics/atc_basics_firstproject_remap4.jpg){.aligncenter .size-medium}
...
The final look is up to you. What matters here is that all tools ran correctly and the tool changes happened automatically.
