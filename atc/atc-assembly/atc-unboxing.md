...
*** Is there a way to make the drop downs more obvious?
...
<details>
<summary><strong>Box 1: ATC Main Box </strong></summary>
...
This is expected to take 2-4 hours depending on whether you need to remove or reassemble existing components on your machine, a list of preparation tasks can be found here [LINK TO WELCOME PAGE].
