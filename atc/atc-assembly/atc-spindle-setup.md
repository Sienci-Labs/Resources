...
5. From the other side of the drag chain, remove the **female end link** and place it on the **X-axis drag chain pickup**. Secure it with **two M4-8mm? bolts and nuts**.
6. Make sure the clips on your existing AltMill X drag chain are undone and that the **drag chain mount at the back of the XZ axis is removed** before proceeding.
7. From the existing X drag chain, remove the male drag chain end link and attach it to the X-axis drag chain pickup with **M4-8 mm screws**.
8. Attach the assembled X-axis drag chain to the back of the Z-axis assembly using the screws from the previously removed drag chain mount.
