...
Check out our video where Johann goes through how to set up and quickly begin each Vortex project.

Note: The video below shows the Open Loop Vortex. For **Closed Loop Vortex, use 4th Axis Mode** instead of Rotary Mode on gSender.
