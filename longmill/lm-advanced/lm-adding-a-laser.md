...
You can find all the info about grbl and how "laser mode" works on this page: <a href="https://github.com/gnea/grbl/wiki/Grbl-v1.1-Laser-Mode" target="_blank" rel="nofollow noopener noreferrer">https://github.com/gnea/grbl/wiki/Grbl-v1.1-Laser-Mode</a>. The key takeaways are that you'll need to alter three machine settings to prepare your CNC for using a laser:
