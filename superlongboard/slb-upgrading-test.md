...
skip_file: no
featured_image: _images/_superlongboard/_upgrading/slb_upgrading_p1_SLB.jpg
---
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p2_open.png){.aligncenter .size-medium}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p18_Connect1.jpg){.aligncenter .size-full .nar}
1. Connecting to the SLB, requires you to select a new button. Click the gray bar at the bottom labelled Firmware.
![](/_images/_superlongboard/_upgrading/slb_upgrading_p19_Connect2.jpg){.aligncenter .size-full .nar}
1. Then click on **grblHAL**.
![](/_images/_superlongboard/_upgrading/slb_upgrading_p20_Connect3.jpg){.aligncenter .size-full .nar}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p21_Connect4.jpg){.aligncenter .size-full .nar}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p22_Connected.jpg){.aligncenter .size-full .nar}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p26_Unlock.jpg){.aligncenter .size-full}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p27_JogControl.jpg){.aligncenter .size-full}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p29_Probe.jpg){.aligncenter .size-full}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p37_SpindleLaser.jpg){.aligncenter .size-full}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p38_SLBSpindle.jpg){.aligncenter .size-full}
...
![](/_images/_superlongboard/_upgrading/slb_upgrading_p39_LaserTest.jpg){.aligncenter .size-full}
