...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_switches.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_homing-positions.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_zaxis.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_xaxis.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_bracket.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_yaxis-slot.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_yaxis.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_wire1.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_wiredrag.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_firmware-newu.jpg){.aligncenter .size-full}

Don't forget to hit the **Apply Settings** button once any changes are made.

[tabby title="Classic gSender"]

![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_hard-limits.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_alarm-newu.jpg){.aligncenter .size-full}

[tabby title="Classic gSender"]

![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_alarm.jpg){.aligncenter .size-medium}
...
![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_workspaces-newu.jpg){.aligncenter .size-medium}

[tabby title="Classic gSender"]

![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_workspaces.jpg){.aligncenter .size-medium}
...
The first step is to figure out how to wire your switches. If you have NPN or PNP type switches (common with inductive sensors), you’ll have 3 wires; GND, signal, and 5V. If you have NO or NC type switches (common with mechanical/button switches), you’ll only need to use two wires; COM, and NC or NO.
...
Settings can be changed by going to the **Config Tab**, updating the applicable **'Homing/Limits' settings**, then clicking the 'Apply Settings' button.

![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_firmware-newu.jpg){.aligncenter .size-full}

[tabby title="Classic gSender"]

Settings can be changed by sending the command to update the EEPROM settings manually through the console or using the **Firmware** tool in gSender. Below are several of the limit switch related settings you may look to edit as well as their respective commands.

![](/_images/_lmmk2/_add-ons/_limits/lmk2_add_li_firmware.jpg){.aligncenter .size-medium}
