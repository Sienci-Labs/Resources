...
1. Grab the Z-axis assembly. **Rotate** the Z-axis leadscrew at the coupler, so the small gantry **bottoms out**. You should now have access to the four (4) router mount holes.
