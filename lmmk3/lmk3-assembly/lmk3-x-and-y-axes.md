...
1. Take out the two (2) Y-axis assemblies. The goal is to get the white anti-backlash nuts to the same position on each Y-axis. To adjust the anti-backlash nut: rotate the black clamping nuts at the front Y plates. Then slide the black linear guide blocks above the white anti-backlash nut.
...
1. On one of the Y-axes, loosely secure two (2) M4-12mm screws into the bottom holes of the linear guide blocks.

    ![](/_images/_lmmk3/_assembly/_xy_axes/lmk3_xy_axes-render05.jpg){.aligncenter .size-medium}
...
1. Have your friend or foam support the X-axis rail. Place the X-axis assembly onto the Y-axis gantry at the notches, anchoring onto the M4-12mm screws.
...
1. Finish securing the two (2) M4-12mm screws using an Allen key.
...
![](/_images/_lmmk3/_assembly/lmk3_xmotor-partsneededv2.jpg){.aligncenter .size-medium}
...
1. Place one (1) standoff between the motor and Y gantry, then insert one (1) M5-50mm screw through the motor and the standoff, loosely fastening into the gantry. Repeat this for the remaining three (3) holes. Then fully secure all M5-50mm screws until snug.
...
1. Secure the nut and lock washer against the gantry plate using the LongMill wrench.

        💡 Tip: If adjusting the motor, tighten the coupler first, then tighten down the motor standoffs.

Congrats on finishing up the first section of assembly! You are well on your way.
